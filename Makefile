...
PROGS       = afl-gcc afl-fuzz afl-replay aflnet-replay afl-showmap afl-tmin afl-gotcpu afl-analyze replayer
...
ifneq "$(filter Linux GNU%,$(shell uname))" ""
  LDFLAGS  += -ldl -lgvc -lcgraph -lm -lrt
endif
...
afl-fuzz: afl-fuzz.c $(COMM_HDR) aflnet.o aflnet.h state_machine.o state_machine.h | test_x86
	$(CC) $(CFLAGS) $@.c aflnet.o state_machine.o -o $@ $(LDFLAGS)
...
replayer: replayer.c $(COMM_HDR) aflnet.o aflnet.h | test_x86
	$(CC) $(CFLAGS) $@.c aflnet.o -o $@ $(LDFLAGS)
